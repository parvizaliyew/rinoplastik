...
class SeoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        [
            ...
            'meta_keyword.required'=>'Zəhmət olmasa meta keywoord-u  daxil edin',
            'meta_desc.required'=>'Zəhmət olmasa meta description-u daxil edin',
            'title.required'=>'Zəhmət olmasa title daxil edin',
        ]);
        if ($validator->fails()) {
