jQuery(function ($) {
	...
	// Buy Now Btn
	$('body').append("<a href='https://themeforest.net/checkout/84509374/create_account?_ga=2.171400224.1430237439.1644119533-1297998632.1635997908' target='_blank' class='buy-now-btn'>Buy Now</a>");
...
function setTheme(themeName) {
    localStorage.setItem('mebid_theme', themeName);
    document.documentElement.className = themeName;
}
// function to toggle between light and dark theme
function toggleTheme() {
    if (localStorage.getItem('mebid_theme') === 'theme-dark') {
