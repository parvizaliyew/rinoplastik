...
<div class="main_content_iner ">
    <div class="col-lg-12">
        ...
        <h3 class="m-0">Sertifikat Əlavə et</h3>
        </div>
        ...
        <div class="card-body">
        <form method="POST" enctype="multipart/form-data" action="{{ route('admin.certifcat.store') }}">
        @csrf
        <div class="row mb-3">
                <div class="col-md-6">
        ...
        <a href="{{ route('admin.certifcat.index') }}" class="btn btn-success">Back</a>
